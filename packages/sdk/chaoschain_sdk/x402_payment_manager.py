...
class X402PaymentManager:
    ...
    def _get_treasury_address(self) -> str:
        ...
        treasury = os.getenv("CHAOSCHAIN_TREASURY_ADDRESS")
        if not treasury:
            # Default treasury addresses per network
            treasury_addresses = {
            ...
            treasury = treasury_addresses.get(self.network, "0x20E7B2A2c8969725b88Dd3EF3a11Bc3353C83F70")

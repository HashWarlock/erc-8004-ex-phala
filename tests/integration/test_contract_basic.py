...
identity = w3.eth.contract(address=contracts["IdentityRegistry"], abi=identity_abi)
...
try:
    ...
    # Build transaction
    tx = identity.functions.newAgent("alice.test.com", alice).build_transaction(
        {
            "from": alice,
            "value": fee,
            "gas": 500000,
    ...
    signed = w3.eth.account.sign_transaction(
        tx, "0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d"
    )

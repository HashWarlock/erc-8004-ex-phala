...
def deploy_contract(
    w3: Web3, account, contract_name: str, constructor_args=None
) -> tuple:
...
def main():
    ...
    try:
        ...
        addr, tx = deploy_contract(
            w3, account, "ReputationRegistry", [addresses["identity_registry"]]
        )
        ...
        addr, tx = deploy_contract(
            w3, account, "ValidationRegistry", [addresses["identity_registry"]]
        )
